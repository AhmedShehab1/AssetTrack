    ...
    <div className="w-full bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100/50 overflow-hidden">
      <div className="p-8 sm:p-12 pb-10">
        <div className="flex flex-col items-center justify-center mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-[#1A237E] tracking-tight font-heading">Reset Password</h1>
          <p className="text-gray-400 text-sm mt-3 font-medium tracking-wide text-center">
            Recover your AssetTrack account
          </p>
        </div>
      ...
      <div className="border-t border-gray-100 bg-[#FAFBFE] p-6 flex justify-center items-center">
        <p className="text-sm text-gray-400 font-medium">
          Don't have an account? <Link to="/signup" className="text-[#253B95] font-bold hover:underline ml-1">Request Access</Link>
        </p>
      </div>
    </div>
  );
