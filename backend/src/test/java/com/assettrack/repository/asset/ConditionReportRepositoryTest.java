...
class ConditionReportRepositoryTest {
        ...
        void findByAssetIdOrderByReportDateDesc_ReturnsReportsNewestFirst() {
                reportRepository.save(ConditionReport.builder()
                                ...
                                .reportDate(LocalDateTime.of(2025, 1, 1, 9, 0))
                ...
                reportRepository.save(ConditionReport.builder()
                                ...
                                .reportDate(LocalDateTime.of(2025, 5, 1, 9, 0))
                                .severity(ConditionSeverity.HIGH)
                                .build());

                List<ConditionReport> reports = reportRepository.findByAssetIdOrderByReportDateDesc(testAsset.getId());
        ...
        void findByReportedByIdOrderByReportDateDesc_ReturnsUserReports() {
                ...
                List<ConditionReport> reports = reportRepository
                                .findByReportedByIdOrderByReportDateDesc(testUser.getId());
