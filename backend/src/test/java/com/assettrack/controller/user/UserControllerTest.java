...
class UserControllerTest {
    ...
    class GetMyProfile {
        ...
        void success() throws Exception {
            UserResponse response = buildResponse(TEST_ID, "alice@example.com");
    ...
    class GetUserById {
        ...
        void notFound() throws Exception {
            ...
            mockMvc.perform(get("/users/d16a68af-84e8-4fe8-9c8d-f21dc2c8f17c"))
    ...
    class UpdateEmail {
        ...
        void success() throws Exception {
            ...
            UserResponse response = buildResponse(TEST_ID, "new@example.com");
    ...
    class UpdateUserRole {
        ...
        void success() throws Exception {
            UserResponse response = buildResponse(TEST_ID, "bob@example.com");
        ...
        void invalidRole() throws Exception {
            when(userService.updateUserRole(eq(TEST_ID), eq("SUPERUSER"), any()))
        ...
        void selfRole() throws Exception {
            when(userService.updateUserRole(eq(TEST_ID), any(), any()))
    ...
    class UpdateUserStatus {
        ...
        void selfStatus() throws Exception {
            when(userService.updateUserStatus(eq(TEST_ID), anyBoolean(), any()))
    ...
    class DeleteUser {
        ...
        @DisplayName("returns 204 on success")
        void success() throws Exception {
            doNothing().when(userService).deleteUser(eq(TEST_ID), any());

            mockMvc.perform(delete("/users/" + TEST_ID))
                    .andExpect(status().isNoContent());
        }
        ...
        void notFound() throws Exception {
            doThrow(new ResourceNotFoundException("User not found"))
                    .when(userService).deleteUser(eq(TEST_ID), any());
