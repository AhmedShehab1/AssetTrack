...
class AllocationControllerTest {
    ...
    @Nested
    @DisplayName("GET /assets/{assetId}/allocations")
    class GetAllocations {

        @Test
        @WithMockUser(roles = "ADMIN")
        void success() throws Exception {
            Page<AllocationHistoryDto> page = new PageImpl<>(List.of(buildHistory()));
            when(allocationService.getAllocationHistory(eq(ASSET_ID), any())).thenReturn(page);

            mockMvc.perform(get("/assets/" + ASSET_ID + "/allocations"))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.content[0].allocationId").value(ALLOCATION_ID.toString()))
    ...
    @Nested
    @DisplayName("POST /assets/{assetId}/allocations")
    class Allocate {
        ...
        void success() throws Exception {
            ...
            mockMvc.perform(post("/assets/" + ASSET_ID + "/allocations")
    ...
    @Nested
    @DisplayName("GET /assets/{assetId}/allocations/{allocationId}")
    class GetAllocation {
        ...
        void success() throws Exception {
            ...
            mockMvc.perform(get("/assets/" + ASSET_ID + "/allocations/" + ALLOCATION_ID))
                    .andExpect(status().isOk())
    ...
    @Nested
    @DisplayName("POST /assets/{assetId}/allocations/deallocate")
    class Deallocate {
        ...
        void success() throws Exception {
            ...
            mockMvc.perform(post("/assets/" + ASSET_ID + "/allocations/deallocate"))
