...
class NotificationServiceTest {
        ...
        void getCurrentUserNotifications_ReturnsOnlyAlertsForLoggedInUser() {
                ...
                List<NotificationResponse> responses = notificationService.getCurrentUserNotifications(authentication);

                assertThat(responses).hasSize(1);
                assertThat(responses.get(0).getMessage()).isEqualTo("Laptop warranty expires soon");
